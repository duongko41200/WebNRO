      ...
      <div class="row">
        ...
        <div class="col-10 pl-0">
          <div class="alert alert-success">
            ...
            <div class="row pl-2">
              <b class="text text-danger" style="font-size: 18px;"> Hướng dẫn tải IOS</b>
            </div>
            <p>Thân chào các <span style="color:#3498db"><strong>Chiến binh,</strong></span></p>
            <p>Dưới đây là tổng hợp mod bản IOS của <span style="color:#e83e8c"><strong>Đế Vương</strong></span> </p>
            <div>
              <a href="https://install.appcenter.ms/users/tugino/apps/devuong/distribution_groups/public" class="btn btn-primary text-white my-2" download>
                <i class="fa fa-download"></i> MOD IOS TRỰC TIẾP
              </a>
              <a href="hhttps://install.appcenter.ms/users/tugino/apps/devuong_koi/distribution_groups/public" class="btn btn-primary text-white my-2" download>
                <i class="fa fa-download"></i> MOD IOS TRỰC TIẾP KOI
              </a>
              <a href="./taive/DeVuong.ipa" class="btn btn-primary text-white my-2" download>
                <i class="fa fa-download"></i> MOD IOS IPA
              </a>
              <a href="./taive/DeVuong_Koi.ipa" class="btn btn-primary text-white my-2" download>
                <i class="fa fa-download"></i> MOD IOS KOI IPA
              </a><br>

              <a href="https://www.youtube.com/watch?v=QwnjV3Xu_sg" class="btn btn-primary text-white my-2" download>
                <i class="fas fa-photo-video"></i> Hướng dẫn cài SCARLET
              </a>
              <br>
              <a href="https://anotepad.com/notes/b3wakt7q" class="btn btn-primary text-white my-2" download>
                <i class="fas fa-certificate"></i> Chặn thu hồi chứng chỉ
              </a>

              <a href="https://www.youtube.com/watch?v=v5FFhxi9gEc" class="btn btn-primary text-white my-2" download>
                <i class="fas fa-photo-video"></i> Hướng dẫn cài Esign
              </a>
              <br>
              <a href="./taive/esign_4.7.3.1_unsign.ipa" class="btn btn-primary text-white my-2" download>
                <i class="fas fa-certificate"></i> File Esign
              </a>
              <a href="./taive/XCMG Foundation Construction Machinery Co., Ltd.zip" class="btn btn-primary text-white my-2" download>
                <i class="fas fa-certificate"></i> File Chứng Chỉ
              </a>
            </div>
