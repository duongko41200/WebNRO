...
$taikhoanmb = '0356847598'; // tài khoản đăng nhập mbbank của bạn tại https://online.mbbank.com.vn
$deviceIdCommon = 'vi7bczuj-mbib-0000-0000-2023060822393787'; // thay cái thông số mà bạn lấy đc từ F12 vào đây 
$sessionId = 'ce3fd81c-6caa-4dcc-b3c1-6048a49484e5'; // thay cái thông số mà bạn lấy đc từ F12 vào
$sotaikhoanmb = '9178100322';
...
$ch = curl_init($url);
curl_setopt($ch, CURIOPT_POST, 1);
curl_setopt($ch, CURIOPT_POSTFIELDS, $postdata);
