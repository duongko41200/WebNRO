      ...
      <div class="row">
        ...
        <div class="col-10 pl-0">
          <div class="alert alert-success">
            ...
            <div class="row pl-2">
              <b class="text text-danger" style="font-size: 18px;"> Hướng dẫn tải JAR</b>
            </div>
            <p>Thân chào các <span style="color:#3498db"><strong>Chiến binh,</strong></span></p>
            <p>Dưới đây là tổng hợp mod bản JAR của <span style="color:#e83e8c"><strong>Đế Vương</strong></span> </p>
            <div>
              <a href="./taive/Đế Vương.jar" class="btn btn-primary text-white my-2" download>
                <i class="fa fa-download"></i> Đang fix
              </a><br>
            </div>
